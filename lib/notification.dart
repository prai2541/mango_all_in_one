                    ...
                    itemBuilder: (context, j) {
                      if(rawData.years[i].months[j].days != null) {
                        return ExpansionTile(
                          ...
                          title: Text('${rawData.years[i].months[j].month} ${rawData.years[i].year}'),
                          children: <Widget>[
                            Container(
                              child: ListView.builder(
                                shrinkWrap: true,
                                itemCount: rawData.years[i].months[j].days.length,
                                itemBuilder: (context, k) {
                                  return ListTile(
                                    title: Text('${rawData.years[i].months[j].days[k].day}'),
                                    trailing: Icon(Icons.arrow_forward_ios, size: ScreenUtil.instance.setHeight(16),),
                                    onTap: () {
                                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => new NormalAlertDetail(rawData.years[i].months[j].days[k].day, rawData.years[i].months[j].days[k].datas)));
                                    },
                                  );
                                },
                              ),)
                          ...
                          children: <Widget>[
                            Container(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, k) {
                                  return ListTile(
                                    title: Text('${rawData.years[i].months[j].days[k].day} ${rawData.years[i].months[j].month} ${rawData.years[i].year}'),
                                    trailing: Icon(Icons.arrow_forward_ios, size: ScreenUtil.instance.setHeight(16),),
                                    onTap: () {
