    ...
    if (customizable || matName == 'Material Name') {
      return Container(
        ...
        child: Text(
          '$matName',
          style: TextStyle(
              fontSize: ScreenUtil.instance.setSp(16), color: Colors.grey[600]),
        ),
      ...
      return Container(
        ...
        child: Text(
          '$matName',
          style: TextStyle(
              fontSize: ScreenUtil.instance.setSp(16), color: Colors.black),
        ),
        decoration: new BoxDecoration(
      ...
      return InkWell(
          ...
          onTap: () async {
            if (!customizable) {
              ...
              MaterialList result = await Navigator.push(
                  context, MaterialPageRoute(builder: (context) => MatAdd()));
              if (result != null) {
                setState(() {
      ...
      return Container(
        ...
        child: Row(
          children: <Widget>[
            Text('เพิ่ม ',
                style: TextStyle(
                    color: Color(0xFF00b89c).withOpacity(0.5),
                    fontSize: ScreenUtil.instance.setSp(16))),
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              RaisedButton(
                onPressed: () {
                  MaterialObj newdata = MaterialObj(
                      matcode: mcCtrl.text,
                      matname: matname,
                      qty: int.parse(qtyCtrl.text),
                      unit: int.parse(unitCtrl.text),
                      ppn: int.parse(ppnCtrl.text));
                  setState(() {
                    data.add(newdata);
                    mcCtrl.text = '';
                    qtyCtrl.text = '';
                                      ...
                                      showDialog(
                                          ...
                                          builder: (context) {
                                            return AlertDialog(
                                              ...
                                              content: Text(
                                                  'This will delete your current entry'),
                                              actions: <Widget>[
                                                FlatButton(
                                                  child: Text('Yes'),
                                                  onPressed: () {
            ...
            appBar: AppBar(
              ...
              bottom: TabBar(
                ...
                tabs: [
                  Tab(
                      child:
                          Text('Add', style: TextStyle(fontFamily: 'Prompt'))),
                  Tab(child: listBadge()),
                ],
              ),
              title: Text(
