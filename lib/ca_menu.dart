      ...
      children: <Widget>[
        Row(
          children: <Widget>[
            Expanded(
              flex: 1,
              child: menu('Count Assets', Icons.monetization_on)
            ),
            Container(height: ScreenUtil.instance.setHeight(50), child: VerticalDivider(width: 1,)),
            Expanded(
              flex: 1,
              child: menu('New Asset', Icons.add_circle, () {Navigator.of(context).pushNamed('/ca-new-entry');})
            )
          ],
        ),
        Divider(height: 1,),
        Row(
          children: <Widget>[
            ...
            Expanded(
              flex: 1,
              child: menu('Assets in the Project', Icons.add_circle)
            )
          ],
        ),
        Divider(height: 1,),
        Row(
          children: <Widget>[
            ...
            Expanded(
              flex: 1,
              child: menu('Assets New', Icons.add_circle)
            )
          ],
        ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        children: <Widget>[
          ...
          SizedBox(height: ScreenUtil.instance.setHeight(10)),
          Text('$text', style: TextStyle(color: Colors.white, fontSize: ScreenUtil.instance.setSp(15)),)
        ],
      )),
    );
  }
