...
class AssetList extends StatelessWidget {
  ...
  List<Asset> assetlist = [Asset(null, 'A.0001', 'อาคาร'), Asset(null, 'A.0002', 'เก้าอี้'), Asset(null, 'A.0003', 'โต๊ะ'), Asset(null, 'A.0004', 'projector')];

  Widget build(context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Asset List', style: TextStyle(fontFamily: 'Prompt', color: Colors.white)),
            ...
            itemBuilder: (context, index) {
              if (assetlist[index].img == null) {
                return InkWell(
                  ...
                  onTap: () {
                    AssetLists asset = AssetLists(assetlist[index].no, assetlist[index].name);
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          ...
                          child: Column(
                                ...
                                children: [
                                  Text('Asset No. :  ${assetlist[index].no} ', 
                                    style: TextStyle(
                                      fontSize: ScreenUtil.instance.setSp(16)
                                    ),
                                  ),
                                  SizedBox(height: ScreenUtil.instance.setHeight(10)),
                                  Text('Asset Name :  ${assetlist[index].name}', 
                                    style: TextStyle(
                                      fontSize: ScreenUtil.instance.setSp(16)
                                    ),
                                  ),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        Expanded(
                          flex: 1,
                          child: Image.file(assetlist[index].img,
                            fit: BoxFit.fill,
                          ),
                        ),
                        Expanded(
                          ...
                          child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  AutoSizeText('Asset No. :  ${assetlist[index].no} ', 
                                    maxLines: 1,
                                    stepGranularity: 1,
                                    style: TextStyle(
                                      fontSize: ScreenUtil.instance.setSp(16)
                                  ...
                                  SizedBox(height: ScreenUtil.instance.setHeight(10)),
                                  AutoSizeText('Asset Name :  ${assetlist[index].name}', 
                                    maxLines: 1,
                                    stepGranularity: 1,
                                    style: TextStyle(
                                      fontSize: ScreenUtil.instance.setSp(16)
