...
class MatAddsState extends State<MatAdds> with SingleTickerProviderStateMixin {
  ...
  List<MaterialList> matlist = [
    MaterialList(matcode: '1', matname: '1'),
    MaterialList(matcode: '2', matname: '2'),
    MaterialList(matcode: '3', matname: '3')
  ];
                ...
                return InkWell(
                    ...
                    onTap: () {
                      MaterialList mat = MaterialList(
                          matcode: matlist[index].matcode,
                          matname: matlist[index].matname);
