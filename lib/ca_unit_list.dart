...
import 'package:app_ui/unit.dart';
...
class UnitList extends StatelessWidget {
  ...
  List<Unit> unitlist = [Unit('001','bottle'), Unit('002','piece'), Unit('003','set'), Unit('004','meter'), Unit('005','kilogram')];

  Widget build(context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Unit List', style: TextStyle(fontFamily: 'Prompt', color: Colors.white)),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        Expanded(
                          flex: 1,
                          child: Center(child: Text('${unitlist[index].no}'))
                        ),
                        Expanded(
                          flex: 3,
                          child: Text('${unitlist[index].name}')
                          ),
                      ],
                    )
                  )
